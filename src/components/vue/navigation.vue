<template>
    <div class="w-full max-w-screen overflow-x-hidden">
        <nav class="bg-gray-800 w-full overflow-x-hidden">
            <div class="w-full max-w-7xl mx-auto box-border px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <!-- Logo / Brand -->
                    <div class="flex-shrink-0">
                        <span class="text-2xl font-semibold text-white">Aren M</span>
                    </div>

                    <!-- Desktop Menu -->
                    <div class="hidden space-x-8 md:flex">
                        <a href="/"
                            class="text-lg font-medium text-gray-300 hover:text-white px-3 py-2 rounded-md">Home</a>
                        <a href="/projects"
                    ...
                    <div class="md:hidden">
                        <button type="button" @click="mobileMenuOpen = !mobileMenuOpen"
                            class="text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white overflow-hidden"
            ...
            <div v-if="mobileMenuOpen" class="md:hidden px-2 pt-2 pb-3 space-y-1 bg-gray-700">
                <a href="/"
                    class="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-600">Home</a>
                <a href="/projects"
